...
int divv_h_limited(Vector_field, Scalar_field, Grid *, Scalar_field, double);
...
int hori_momentum_diffusion(State *, Diagnostics *, Irreversible_quantities*, Config *, Grid *, Dualgrid *);
