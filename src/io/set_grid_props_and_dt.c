...
int set_grid_properties(Grid *grid, Dualgrid *dualgrid, char grid_file_name[])
{
	...
	*/
    ...
    vorticity_signs_triangles_id, latitude_scalar_id, longitude_scalar_id, no_of_shaded_points_scalar_id, no_of_shaded_points_vector_id, toa_id, radius_id, vert_grid_type_id,
