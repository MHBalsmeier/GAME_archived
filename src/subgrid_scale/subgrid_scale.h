...
int hori_div_viscosity_eff(State *, Irreversible_quantities *, Grid *, Diagnostics *, Config *, double);
int hori_curl_viscosity_eff_rhombi(State *, Irreversible_quantities *, Grid *, Diagnostics *, Config *, double);
int hori_curl_viscosity_eff_triangles(State *, Irreversible_quantities *, Grid *, Dualgrid *dualgrid, Diagnostics *, Config *, double);
