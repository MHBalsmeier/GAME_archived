...
int vector_tendencies_expl(State *, State *, Grid *, Dualgrid *, Diagnostics *, Forcings *, Irreversible_quantities *, Config *, int, double, int);
int scalar_tendencies_expl(State *, State *, State *, Grid *, double, Diagnostics *, Forcings *, Irreversible_quantities *, Config *, int);
