...
mkdir $output_dir
mpirun -np $number_of_cpus ./core/game $run_span $write_out_interval $grid_props_file $init_state_file $output_dir $cfl_margin $momentum_diffusion_on $rad_on $tracers_on $operator $write_out_mass_dry_integral $write_out_entropy_gas_integral $write_out_energy_integral $scalar_diffusion_on $radiation_delta_t $column_mode $column_index
# valgrind ./core/game $run_span $write_out_interval $grid_props_file $init_state_file $output_dir $cfl_margin $momentum_diffusion_on $rad_on $tracers_on $operator $write_out_mass_dry_integral $write_out_entropy_gas_integral $write_out_energy_integral $scalar_diffusion_on $radiation_delta_t $column_mode $column_index
