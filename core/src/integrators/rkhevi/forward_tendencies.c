...
int forward_tendencies(State *state, State *state_tendency, Grid *grid, Dualgrid *dualgrid, Diagnostics *diagnostics, Forcings *forcings, Interpolation_info *interpolation_info, Irreversible_quantities *irreversible_quantities, Config_info *config_info, int no_step_rk)
{
	// Update of the pressure gradient.
	manage_pressure_gradient(state, grid, dualgrid, diagnostics, forcings, interpolation_info, irreversible_quantities, config_info, no_step_rk);
