...
int integrate_continuity_dry(State *, State *, Interpolate_info *, State *, Grid *, Dualgrid *, Scalar_field, Diagnostics *, Forcings *, Diffusion_info *, Config_info *, int);
...
int integrate_entropy_density_gas(State *, State *, Interpolate_info *, State *, Grid *, Dualgrid *, Scalar_field, Diagnostics *, Forcings *, Diffusion_info *, Config_info *, int);
