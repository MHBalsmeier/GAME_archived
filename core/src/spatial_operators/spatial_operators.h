...
int explicit_momentum_tendencies(State *, State *, Grid *, Dualgrid *, int, int, Scalar_field, Scalar_field, Vector_field, Vector_field, Scalar_field, Scalar_field, Curl_field, Curl_field, Vector_field, Vector_field, Vector_field, Vector_field, Scalar_field, Scalar_field, Scalar_field, Vector_field, int, Vector_field, Vector_field, int, int);
