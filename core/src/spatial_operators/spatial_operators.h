...
int explicit_momentum_tendencies(State *, State *, Grid *, Dualgrid *, int, int, Scalar_field, Vector_field, Scalar_field, Curl_field, Vector_field, Vector_field, Vector_field, Scalar_field, Scalar_field, Scalar_field, Vector_field, int, Vector_field, Vector_field, int, Vector_field, Vector_field, int, Diffusion_info *);
int calc_partially_implicit_divvs(State *, State *, State_interpolate *, State *, Grid *, Dualgrid *, int, int, int, double, int, Scalar_field, int, Vector_field, Scalar_field, Scalar_field, Vector_field, Scalar_field, Vector_field, Vector_field, int, Scalar_field, int, Scalar_field, Vector_field, Diffusion_info *);
