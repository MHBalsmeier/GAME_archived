...
int calc_partially_implicit_divvs(State *, State *, State *, Grid *, Dualgrid *, int, int, int, double, int, Scalar_field, int, Vector_field, Scalar_field, Scalar_field, Vector_field, Scalar_field, Vector_field, Vector_field, int, Scalar_field, int, Scalar_field, Vector_field, Diffusion_info *);
