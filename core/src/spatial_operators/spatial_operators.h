...
int vorticity_flux(Vector_field, Dual_vector_field, Vector_field, Grid *);
...
int momentum_diff_diss(State *, Diagnostics*, Irreversible_quantities*, Config_info *, Grid *, Dualgrid *);
