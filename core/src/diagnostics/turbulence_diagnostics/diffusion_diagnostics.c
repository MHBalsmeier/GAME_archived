...
int calc_mass_diffusion_coeffs(Scalar_field *temperature, Scalar_field *density, Scalar_field *mass_diffusion_coeff_numerical_h, Scalar_field *mass_diffusion_coeff_numerical_v)
{
	...
	for (int i = 0; i < NO_OF_SCALARS; ++i)
    {
        ...
        (*mass_diffusion_coeff_numerical_h)[i] = 0*mass_diffusion_coeff_para_ratio_h*mass_diffusion_coeff;
        (*mass_diffusion_coeff_numerical_v)[i] = 0*mass_diffusion_coeff_para_ratio_v*mass_diffusion_coeff;
    }
	return 0;
}
