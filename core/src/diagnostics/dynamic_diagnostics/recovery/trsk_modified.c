    ...
    *component = 0;
	...
	if (grid -> from_index[h_index] < NO_OF_PENTAGONS)
	{
	    *component += 
		...
		+ grid -> trsk_modified_weights[10*h_index + 2]*in_field_0[NO_OF_SCALARS_H + layer_index*NO_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + 2]]*in_field_1[NO_OF_VECTORS_H + layer_index*2*NO_OF_VECTORS_H  + grid -> trsk_modified_curl_indices[10*h_index + 2]]
	...
	if (grid -> to_index[h_index] < NO_OF_PENTAGONS)	
	{
	    *component += 
		...
		+ grid -> trsk_modified_weights[10*h_index + 7]*in_field_0[NO_OF_SCALARS_H + layer_index*NO_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + 7]]*in_field_1[NO_OF_VECTORS_H + layer_index*2*NO_OF_VECTORS_H  + grid -> trsk_modified_curl_indices[10*h_index + 7]]
