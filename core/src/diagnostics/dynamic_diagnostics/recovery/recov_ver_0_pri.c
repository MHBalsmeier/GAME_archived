...
This is a recovery function at vertical vector points. The x component of a Vector_field is diagnozed here. If layer_index >= NO_OF_LAYERS - NO_OF_ORO_LAYERS, a vertical interpolation of the input field onto the desired z coordinate must be done.
*/
