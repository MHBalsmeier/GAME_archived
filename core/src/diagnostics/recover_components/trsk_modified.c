    ...
    *component = 0;
    ...
    else
    {
		for (int i = 0; i < 10; ++i)
		{
		    ...
		    unmodified_value = grid -> trsk_modified_weights[10*h_index + i]*in_field_0[NUMBER_OF_VECTORS_V + layer_index*NUMBER_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + i]]*in_field_1[NUMBER_OF_DUAL_VECTORS_H + layer_index*(NUMBER_OF_DUAL_VECTORS_H + NUMBER_OF_VECTORS_H) + grid -> trsk_modified_velocity_indices[10*h_index + i]];
			if (layer_index == NUMBER_OF_LAYERS - 1)
			{
				d_input = in_field_0[NUMBER_OF_VECTORS_V + (layer_index - 1)*NUMBER_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + i]]*in_field_1[NUMBER_OF_DUAL_VECTORS_H + layer_index*(NUMBER_OF_DUAL_VECTORS_H + NUMBER_OF_VECTORS_H) + grid -> trsk_modified_velocity_indices[10*h_index + i]] - in_field_0[NUMBER_OF_VECTORS_V + layer_index*NUMBER_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + i]]*in_field_1[NUMBER_OF_DUAL_VECTORS_H + layer_index*(NUMBER_OF_DUAL_VECTORS_H + NUMBER_OF_VECTORS_H) + grid -> trsk_modified_velocity_indices[10*h_index + i]];
			...
			{
				d_input = in_field_0[NUMBER_OF_VECTORS_V + (layer_index - 1)*NUMBER_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + i]]*in_field_1[NUMBER_OF_DUAL_VECTORS_H + layer_index*(NUMBER_OF_DUAL_VECTORS_H + NUMBER_OF_VECTORS_H) + grid -> trsk_modified_velocity_indices[10*h_index + i]] - in_field_0[NUMBER_OF_VECTORS_V + (layer_index + 1)*NUMBER_OF_VECTORS_PER_LAYER + grid -> trsk_modified_velocity_indices[10*h_index + i]]*in_field_1[NUMBER_OF_DUAL_VECTORS_H + layer_index*(NUMBER_OF_DUAL_VECTORS_H + NUMBER_OF_VECTORS_H) + grid -> trsk_modified_velocity_indices[10*h_index + i]];
