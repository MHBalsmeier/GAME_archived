...
int runge_kutta_third_order(State *state_0, State *state_p1, double delta_t, Grid *grid, Dualgrid *dualgrid, int dissipation_on, int rad_on, int tracers_on, int diffusion_on)
{
    ...
    tendency(state_star_star, tendency_star_star, grid, dualgrid, dissipation_on, rad_on, tracers_on, delta_t, diffusion_on);
