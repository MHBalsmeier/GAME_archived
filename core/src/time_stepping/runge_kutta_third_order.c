...
int runge_kutta_third_order(State *state_0, State *state_p1, double delta_t, Grid *grid, Dualgrid *dualgrid)
{
    ...
    tendency(state_star_star, tendency_star_star, grid, dualgrid);
