...
int manage_time_stepping(State *, State *, Interpolate_info *, double, Grid *, Dualgrid *, int, int, int , int, Scalar_field, State *, Vector_field, Scalar_field, Scalar_field, Vector_field, Scalar_field, Vector_field, Scalar_field, Curl_field, Vector_field, Vector_field, Vector_field, Scalar_field, Scalar_field, Vector_field, Vector_field, Vector_field, Vector_field, Vector_field, Scalar_field, int, Scalar_field, Vector_field, Diffusion_info *);
