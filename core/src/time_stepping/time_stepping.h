...
int manage_rkhevi(State *, State *, Soil *, Extrapolation_info *, Grid *, Dualgrid *, Radiation *, State *, Diagnostics *, Forcings *, Irreversible_quantities *, Config_info *, double, double, int);
...
int scalar_tendencies_expl(State *, State *, Soil *soil, Grid *, Dualgrid *, double, Scalar_field, Diagnostics *, Forcings *, Irreversible_quantities *, Config_info *, int, Vector_field);
