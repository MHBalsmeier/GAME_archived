...
int runge_kutta_fourth_order(State *state_0, State *state_p1, double delta_t, Grid *grid, Dualgrid *dualgrid)
{
    ...
    tendency(state_half_from_below, tendency_half_from_below, grid, dualgrid);
    ...
    tendency(state_half_from_above, tendency_half_from_above, grid, dualgrid);
