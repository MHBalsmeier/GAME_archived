...
int runge_kutta_fourth_order(State *state_0, State *state_p1, double delta_t, Grid *grid, Dualgrid *dualgrid, short dissipation_on)
{
    State *tendency_0 = malloc(sizeof(State));
    tendency(state_0, tendency_0, grid, dualgrid, dissipation_on);
    ...
    tendency(state_half_from_below, tendency_half_from_below, grid, dualgrid, dissipation_on);
    ...
    tendency(state_half_from_above, tendency_half_from_above, grid, dualgrid, dissipation_on);
    ...
    tendency(state_star, tendency_star, grid, dualgrid, dissipation_on);
    free(state_star);
