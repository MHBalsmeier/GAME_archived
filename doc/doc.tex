...
\chapter{Surface generator}
\label{sec:surface_generator}

The surface generator resides in the directory \texttt{surface\_generator} and is an individual executable meant to produce surface properties (orography, roughness length, radiative properties, etc.) for different cases defined by the \texttt{oro\_id}, given the horizontal positions of the primal scalar points.
