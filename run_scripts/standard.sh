...
# dynamics settings
cfl_margin=0.45 # The sound time step will be calculated as follows (delta t) = (delta t from horizontal CFL)*(1 - cfl_margin). 0.45 can be considered a standard value.
