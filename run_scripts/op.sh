...
# grid properties
orography_id=${BASH_ARGV[9]} # ID of the orography field. Based on this the grid file will be chosen. For ideal_input_id > -1 orography_id will be set automatically.
