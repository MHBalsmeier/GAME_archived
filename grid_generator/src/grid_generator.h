...
int calc_kinetic_energy_and_volume_ratios(double [], double [], int [], double [], double [], int [], int [], int [], double [], double [], double [], double [], int [], double [], double [], double [], double [], int [], int [], double [], double []);
...
int set_dual_vector_h_doubles(double [], double [], double [], double [], double [], int [], int [], double [], double []);
