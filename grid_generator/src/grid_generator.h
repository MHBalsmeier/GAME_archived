...
int calc_kinetic_energy_and_related(double [], double [], double [], double [], int [], int [], int [], double [], double [], double [], double [], int [], double [], double [], double [], double [], int [], int [], double [], double [], double []);
