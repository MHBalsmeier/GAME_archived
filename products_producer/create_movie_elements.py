import numpy as np;
import sys;
import help_scripts.read_model_output as rmo;
from matplotlib.colors import BoundaryNorm;
import cartopy.feature as cfeature;
import iris;
import help_scripts.game_grid_generator as ggg;
import help_scripts.dist_stuff as ds;
import help_scripts.conversions as conv;
...
core_path = sys.argv[7];
grib_dir_name = sys.argv[8];
...
input_file = core_path + "/" + grib_dir_name + "/init+0s.grb2";
...
for i in np.arange(1, int(max_interval/time_step) + 1):
    ...
    input_file = core_path + "/" + grib_dir_name + "/init+" + str(time_after_init) + "s.grb2";
